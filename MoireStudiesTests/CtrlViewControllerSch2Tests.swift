...
class CtrlViewControllerSch2Tests: XCTestCase {
    ...
    func testConvertToFillRatioAndScaleFactor() {
        let result1 = controllerSch2.convertToFillRatioAndScaleFactor(blackWidth: 10.0, whiteWidth: 10.0)
    ...
    func testConvertToBlackWidthAndWhiteWidth() {
        let result1 = controllerSch2.convertToBlackWidthAndWhiteWidth(fillRatio: 0.5, scaleFactor: 20.0 / Constants.UI.tileHeight)
        ...
        let result2 = controllerSch2.convertToBlackWidthAndWhiteWidth(fillRatio: 0.2, scaleFactor: 50.0 / Constants.UI.tileHeight)
