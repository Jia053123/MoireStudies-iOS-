...
extension MoireManagingControllerTestsWithNormalModel {
    func testModifyMoire_ValidIdLegalValuesAndSaved_ReturnTrueAndModifyPatternAndSaveAndUpdatePatterns() {
        ...
        XCTAssertTrue(self.moireManagingController.modifyPattern(speed: expectedSpeedValue0, callerId: p0Id))
        ...
        XCTAssertTrue(self.moireManagingController.modifyPattern(direction: 1.0, callerId: p1Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(direction: expectedDirectionValue1, callerId: p1Id))
        ...
        XCTAssertTrue(self.moireManagingController.modifyPattern(direction: 1.0, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(speed: 14.0, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(whiteWidth: 3.0, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(direction: 2.0, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(direction: expectedDirection3, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(blackWidth: 7.0, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(whiteWidth: expectedWhiteWidth3, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(speed: 15.0, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(speed: expectedSpeed3, callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.modifyPattern(blackWidth: expectedBlackWidth3, callerId: p3Id))
    ...
    func testModifyMoire_CalledWithHighDegId_ValidIdLegalValues_ReturnFalseWithoutModifying() {
        ...
        self.moireManagingController.configurations = config
        ...
        XCTAssertFalse(self.moireManagingController.modifyPattern(speed: newPattern.speed, callerId: highDegId))
        XCTAssertFalse(self.moireManagingController.modifyPattern(direction: newPattern.direction, callerId: highDegId))
        XCTAssertFalse(self.moireManagingController.modifyPattern(blackWidth: newPattern.blackWidth, callerId: highDegId))
        XCTAssertFalse(self.moireManagingController.modifyPattern(whiteWidth: newPattern.whiteWidth, callerId: highDegId))
    ...
    func testModifyMoire_InvalidIdLegalValuesAndSaved_ReturnFalseAndPatternUnchanged() {
        ...
        XCTAssertFalse(self.moireManagingController.modifyPattern(speed: unexpectedSpeed2, callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.modifyPattern(speed: unexpectedSpeed2, callerId: invalidId2))
        XCTAssertFalse(self.moireManagingController.modifyPattern(direction: unexpectedDirection2, callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.modifyPattern(direction: unexpectedDirection2, callerId: invalidId2))
        XCTAssertFalse(self.moireManagingController.modifyPattern(blackWidth: unexpectedBlackWidth2, callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.modifyPattern(blackWidth: unexpectedBlackWidth2, callerId: invalidId2))
        XCTAssertFalse(self.moireManagingController.modifyPattern(whiteWidth: unexpectedWhiteWidth2, callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.modifyPattern(whiteWidth: unexpectedWhiteWidth2, callerId: invalidId2))
    ...
    func testModifyMoire_ValidIdIlliegalValuesAndSaved_ReturnFalseAndPatternUnchanged() {
        ...
        assert(defaultTestMoireCopy.patterns[2].blackWidth != unexpectedBlackWidth2)
        assert(defaultTestMoireCopy.patterns[2].whiteWidth != unexpectedWhiteWidth2)
        XCTAssertFalse(self.moireManagingController.modifyPattern(speed: unexpectedSpeed2, callerId: p2Id))
        XCTAssertFalse(self.moireManagingController.modifyPattern(direction: unexpectedDirection2, callerId: p2Id))
        XCTAssertFalse(self.moireManagingController.modifyPattern(blackWidth: unexpectedBlackWidth2, callerId: p2Id))
        XCTAssertFalse(self.moireManagingController.modifyPattern(whiteWidth: unexpectedWhiteWidth2, callerId: p2Id))
        // m1C keeps it's original values
        XCTAssert(self.mockMoireViewController.currentPatterns == defaultTestMoireCopy.patterns)
        XCTAssertTrue(self.moireManagingController.saveMoire())
        XCTAssert(self.mockMoireModelNormal.currentMoiresSortedByLastCreatedOrEdited.first(where: {$0.id == defaultTestMoireCopy.id}) == defaultTestMoireCopy)
    ...
    func testModifyMoire_MultiplePatterns_ValidIdLegalValuesAndSaved_ReturnTrueAndModifyPatternsAndSaveAndUpdatePatterns() {
        ...
        XCTAssertTrue(self.moireManagingController.modifyPatterns(modifiedPatterns: m2.patterns, callerId: highDegId1))
    ...
    func testModifyMoire_MultiplePatterns_ValidIdIlliegalValuesAndSaved_ReturnFalseAndPatternsUnchanged() {
        ...
        XCTAssertFalse(self.moireManagingController.modifyPatterns(modifiedPatterns: m3.patterns, callerId: highDegId))
        ...
        XCTAssertFalse(self.moireManagingController.modifyPatterns(modifiedPatterns: m5.patterns, callerId: highDegId))
...
extension MoireManagingControllerTestsWithNormalModel {
    func testModifyDisplayProperties_ValidId_CorrectMethodsCalled() {
        ...
        let p2Id = ids[2]
        let p3Id = ids[3]
        XCTAssertTrue(self.moireManagingController.highlightPattern(callerId: p0Id))
        XCTAssertTrue(self.moireManagingController.highlightPattern(callerId: p1Id))
        XCTAssertTrue(self.moireManagingController.unhighlightPattern(callerId: p1Id))
        XCTAssertTrue(self.moireManagingController.dimPattern(callerId: p2Id))
        XCTAssertTrue(self.moireManagingController.undimPattern(callerId: p2Id))
        XCTAssertTrue(self.moireManagingController.dimPattern(callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.hidePattern(callerId: p0Id))
        XCTAssertTrue(self.moireManagingController.hidePattern(callerId: p3Id))
        XCTAssertTrue(self.moireManagingController.unhidePattern(callerId: p0Id))
    ...
    func testModifyDisplayProperties_InvalidId_ReturnFalseAndMethodsNotCalled() {
        ...
        XCTAssertFalse(self.moireManagingController.highlightPattern(callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.highlightPattern(callerId: invalidId2))
        XCTAssertFalse(self.moireManagingController.unhighlightPattern(callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.dimPattern(callerId: invalidId2))
        XCTAssertFalse(self.moireManagingController.undimPattern(callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.dimPattern(callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.hidePattern(callerId: invalidId2))
        XCTAssertFalse(self.moireManagingController.hidePattern(callerId: invalidId1))
        XCTAssertFalse(self.moireManagingController.unhidePattern(callerId: invalidId2))
...
extension MoireManagingControllerTestsWithNormalModel {
    func testRetrievePattern_ValidId_ReturnCorrespondingPatternOfTheCurrentMoire() {
        ...
        let p0Id = ids[0]
        let p1Id = ids[1]
        assert(self.moireManagingController.modifyPattern(speed: 13.252, callerId: p0Id))
        assert(self.moireManagingController.modifyPattern(direction: 1.234, callerId: p1Id))
        defaultTestMoireCopy.patterns[0].speed = 13.252
        defaultTestMoireCopy.patterns[1].direction = 1.234
        XCTAssert(self.moireManagingController.retrievePattern(callerId: p0Id) == defaultTestMoireCopy.patterns[0])
        XCTAssert(self.moireManagingController.retrievePattern(callerId: p1Id) == defaultTestMoireCopy.patterns[1])
    }
...
extension MoireManagingControllerTestsWithNormalModel {
    func testAppendPattern_MoireEmptyPatternWithinLimitNoCaller_ReturnSuccessAndAppend() {
        self.setUpDefaultTestMoireAndLoad(numOfPatterns: 0)
        XCTAssertTrue(self.moireManagingController.createPattern(callerId: nil, newPattern: Pattern.debugPattern()))
    ...
    func testAppendPattern_MoireNotEmptyPatternWithinLimitHaveCaller_ReturnSuccessAndInsertAfterCallerIndex() {
        self.setUpDefaultTestMoireAndLoad(numOfPatterns: 3)
        let ids = self.mockControlsViewController.ids!
        XCTAssertTrue(self.moireManagingController.createPattern(callerId: ids[1], newPattern: Pattern.debugPattern()))
    ...
    func testAppendPattern_MoireNotEmptyPatternBeyondLimitNoCaller_ReturnFailureMoireStaySame() {
        ...
        XCTAssertFalse(self.moireManagingController.createPattern(callerId: nil, newPattern: Pattern.debugPattern()))
    ...
    func testAppendPattern_MoireNotEmptyPatternBeyondLimitHaveCaller_ReturnFailureMoireStaySame() {
        ...
        self.setUpDefaultTestMoireAndLoad(numOfPatterns: upperbound)
        let ids = self.mockControlsViewController.ids!
        XCTAssertFalse(self.moireManagingController.createPattern(callerId: ids[1], newPattern: Pattern.debugPattern()))
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?.count, upperbound)
        XCTAssertEqual(self.mockControlsViewController.initPatterns?.count, upperbound)
        for i in 0..<5 {
            XCTAssertEqual(self.mockMoireViewController.currentPatterns?[i], defaultTestMoireCopy.patterns[i])
...
extension MoireManagingControllerTestsWithNormalModel {
    func testDeletePattern_PatternNotUnderLimitAndValidId_ReturnTrueAndDeletePattern() {
        ...
        XCTAssertTrue(self.moireManagingController.deletePattern(callerId: ids[1]))
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?.count, 4)
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?[0], defaultTestMoireCopy.patterns[0])
        ...
        XCTAssertTrue(self.moireManagingController.deletePattern(callerId: ids[0]))
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?.count, 3)
        ...
        XCTAssertTrue(self.moireManagingController.deletePattern(callerId: ids[2]))
    ...
    func testDeletePattern_PatternNotUnderLimitAndInvalidId_ReturnFalseAndPatternStaySame() {
        ...
        XCTAssertFalse(self.moireManagingController.deletePattern(callerId: "4"))
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?.count, 3)
        XCTAssertEqual(self.mockControlsViewController.initPatterns?.count, 3)
        for i in 0..<3 {
            XCTAssertEqual(self.mockMoireViewController.currentPatterns?[i], defaultTestMoireCopy.patterns[i])
    ...
    func testDeletePattern_PatternAtLimitAndValidId_ReturnFalseAndPatternStaySame() {
        ...
        let ids = self.mockControlsViewController.ids!
        XCTAssertFalse(self.moireManagingController.deletePattern(callerId: ids[0]))
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?.count, 1)
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?[0], defaultTestMoireCopy.patterns[0])
        XCTAssertEqual(self.mockControlsViewController.initPatterns?.count, 1)
        XCTAssertEqual(self.mockControlsViewController.initPatterns?[0], defaultTestMoireCopy.patterns[0])
    ...
    func testDeletePattern_PatternAtLimitAndInvalidId_ReturnFalseAndPatternStaySame() {
        ...
        XCTAssertFalse(self.moireManagingController.deletePattern(callerId: "8"))
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?.count, 1)
        XCTAssertEqual(self.mockMoireViewController.currentPatterns?[0], defaultTestMoireCopy.patterns[0])
        XCTAssertEqual(self.mockControlsViewController.initPatterns?.count, 1)
        XCTAssertEqual(self.mockControlsViewController.initPatterns?[0], defaultTestMoireCopy.patterns[0])
...
class MoireManagingControllerTestsWithReadonlyModel: MoireManagingControllerTests {
    ...
    func testModifyMoireWithReadonlyModel_NoRuntimeError() {
        ...
        XCTAssertTrue(self.moireManagingController.modifyPattern(speed: speedValueToSet, callerId: p0Id))
        mc.patterns[0].speed = speedValueToSet
        XCTAssert(self.mockMoireViewController.currentPatterns == mc.patterns)
        assert(!self.moireManagingController.saveMoire())
    }
}
