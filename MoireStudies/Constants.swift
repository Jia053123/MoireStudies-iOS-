...
struct Constants {
    ...
    struct Bounds {
        ...
        static let blackWidthRange: ClosedRange<CGFloat> = Constants.UI.tileHeight/2.0...30.0
        static let whiteWidthRange: ClosedRange<CGFloat> = Constants.UI.tileHeight/2.0...30.0
    }
}
